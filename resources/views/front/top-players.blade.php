...
@section('content')
	...
	<section class="feature_section">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="heading">Players Emergencing to the top</h2>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="text_box">
							<span>
								<h3>Syed "SumaiL" Hassan - Dota 2</h3>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="text_box">
							<span>
								<h3>Arslan "Arslan Ash" Siddique - Tekken 7</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="text_box">
							<span>
								<h3>Yawar "Yawar" Hassan - Dota 2</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6">
						<div class="text_box">
							<span>
								<h3>Awais "Awais Honey" Iftikhar - Tekken 7</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
								tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
								quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
